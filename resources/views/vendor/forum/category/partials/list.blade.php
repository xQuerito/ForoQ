<div class="category list-group my-4">
    <div class="list-group-item shadow-sm" style="background-color: var(--color-primary); color: var(--font-color);">
        <div class="row align-items-center text-center">
            <div class="col-sm text-md-start">
                ...
                <p class="card-text text-muted" style="color: var(--font-color);">{{ $category->description }}</p>
            </div>
    ...
    @if ($category->children->count() > 0)
        <div class="subcategories">
            @foreach ($category->children as $subcategory)
                <div class="list-group-item" style="background-color: var(--color-primary);">
                    <div class="row align-items-center text-center">
                        <div class="col-sm text-md-start">
