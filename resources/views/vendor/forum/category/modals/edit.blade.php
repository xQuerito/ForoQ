@component('forum::modal-form')
    ...
    <div class="mb-3">
        ...
        <input type="text" name="title" value="{{ old('title') ?? $category->title }}" class="form-control" style="background-color: var(--color-primary); color: var(--font-color);">
    </div>
    <div class="mb-3">
        <label for="description">{{ trans('forum::general.description') }}</label>
        <input type="text" name="description" value="{{ old('description') ?? $category->description }}" class="form-control" style="background-color: var(--color-primary); color: var(--font-color);">
    </div>
    <div class="mb-3">
