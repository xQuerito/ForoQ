...
@section ('content')
    <div id="edit-post">
        ...
        <form method="POST" action="{{ Forum::route('post.update', $post) }}">
            ...
            <div class="mb-3">
                <textarea name="content" class="form-control" style="background-color: var(--color-primary); color: var(--font-color);">{{ old('content') !== null ? old('content') : $post->content }}</textarea>
            </div>
